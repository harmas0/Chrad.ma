...
import { Search, Ban, ChevronRight, X, AlertTriangle } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { fetchAllUsers, banUser, unbanUser } from '@shared/data/adminApi';
              ...
              <tbody>
                {users.map(u => (
                  <tr key={u.id}>
                    ...
                    <td><span className={ROLE_BADGES[u.role] || ROLE_BADGES.user}>{u.role || 'user'}</span></td>
                    <td><span className={KYC_BADGES[u.kyc_status] || KYC_BADGES.none}>{u.kyc_status || 'none'}</span></td>
                    <td>
                      {u.is_banned ? (
