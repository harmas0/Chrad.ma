...
import { 
  Users, ShieldCheck, AlertTriangle, Package, TrendingUp, Ban, ArrowRight, Clock 
} from 'lucide-react';
import { fetchDashboardStats, fetchAuditLog } from '@shared/data/adminApi';
...
export default function AdminDashboard() {
  ...
  const statCards = [
    { label: 'Total Users', value: stats.totalUsers, icon: Users, variant: 'accent', onClick: () => navigate('/users') },
    { label: 'Active Runners', value: stats.activeRunners, icon: TrendingUp, variant: 'info' },
    { label: 'Pending KYC', value: stats.pendingKyc, icon: ShieldCheck, variant: 'warning', onClick: () => navigate('/kyc') },
    { label: 'Open Disputes', value: stats.openDisputes, icon: AlertTriangle, variant: 'danger', onClick: () => navigate('/disputes') },
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-[14px] text-charcoal-light font-medium">Platform overview and quick actions</p>
      </div>
