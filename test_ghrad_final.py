...
def run_tests():
    ...
    with sync_playwright() as p:
        ...
        # Test 1: Home page
        try:
            clean_and_go("http://localhost:5173/#/")
            text = page.text_content("body")
            if "Fast" in text and "On-Demand" in text:
                results.append(("Home page", "PASS", "Onboarding visible"))
            else:
                results.append(("Home page", "FAIL", "Expected text missing"))
        except Exception as e:
            results.append(("Home page", "FAIL", str(e)))
        
        # Test 2: Onboarding skip
        try:
            clean_and_go("http://localhost:5173/#/onboarding")
        ...
        # Test 6: Admin guard
        try:
            clean_and_go("http://localhost:5173/#/admin")
            url = page.url
